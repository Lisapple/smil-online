<?php
  ...
  function error($description, $index, $code = 1) {
    echo "@=== $description (at index $index)===*" . "\n";
  ...
  class BinOpExpr extends Expr {
    ...
    function execute() {
      ...
      global $_index;
      error("No valid operation for '" . $this->LHS->description() . " $op " . $this->RHS->description() . "'", $_index);
      return;
    }
  }
